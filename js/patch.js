...
function cg(id){
	if(id==-1){ //示例cg，不实际播放
		...
		// 第三阶段：4秒后隐藏文字
		setTimeout("$('.caption').fadeOut(500)",4000); // 4秒后文字用0.5秒淡出
		...
		// 第五阶段：8秒后隐藏文字
		setTimeout("$('.caption').fadeOut(1000)",8000);// 8秒后文字区域用1秒淡出
